...
- **⚠️ AUDIT REMEDIATION (2026-07-19/20, DR-003 — branch `phase1/audit-remediation`): the M4 E2 "FAIL" above is WITHDRAWN as recorded** (sealed timing = 12 stars × 1 repeat; ratio CI [0.42, 1.14] undecided). Current verdict line: **E1 PASS (robust; host-cluster lo95 −0.82 pp; host count corrected to 40) · E2 pending frozen-rule re-measurement** (paused 26/300; resume needs the V-1 skip-done guard; workers ≤6). Edge control (2026-07-19): P=0.5 d gains/losses are **epoch-predicate** phenomena, not detection power. Authorities: `docs/decisions/DR-003_E2_REMEASUREMENT.md` · `research/m4_evaluation/M4_ERRATUM_2026-07-19.md` (§5/§7 pending E2) · `docs/audits/PROJECT_AUDIT_2026-07-19.md`. Execution plan: `docs/ROADMAP_TO_10.md` (Wave 0 active). **Phase II re-scoped** (bound/benchmark/monotransit; Kepler routing-scaling superseded): `docs/VESPER_PHASE2_PROGRAM.md` (DRAFT, pending DR-004; hard-gated behind the roadmap). This bullet supersedes the verdict lines above until the V-4 full status rewrite.
